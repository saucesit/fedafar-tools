...
echo [7/9] Descargando pliegos SaltaCompra y extrayendo items... >> sync_log.txt
"C:\Users\FEDAFAR\AppData\Local\Programs\Python\Python312\python.exe" sc_pliego_scraper.py >> sync_log.txt 2>&1

echo [8/9] Ingesta de licitaciones de Jujuy por email... >> sync_log.txt
"C:\Users\FEDAFAR\AppData\Local\Programs\Python\Python312\python.exe" jujuy_mail_scraper.py >> sync_log.txt 2>&1

echo [9/9] Pusheando stock y precios actualizados a Render... >> sync_log.txt
